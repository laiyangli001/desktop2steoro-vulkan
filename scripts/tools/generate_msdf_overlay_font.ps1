param(
    [string]$Font = "$PSScriptRoot\..\..\src\desktop2stereo\xr_viewer\fonts\NotoSansSC-Regular.otf",
    [string]$Charset = "$PSScriptRoot\..\..\src\desktop2stereo\xr_viewer\fonts\overlay_charset.txt",
    [string]$Output = "$PSScriptRoot\..\..\src\desktop2stereo\xr_viewer\fonts\d2s_overlay_msdf",
    [int]$FontSize = 48,
