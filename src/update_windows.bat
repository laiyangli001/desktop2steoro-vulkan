...
"!PYTHON_EXE!" -m pip install -r "%APP_DIR%\env_install\requirements.txt" --no-cache-dir --no-warn-script-location -i https://repo.huaweicloud.com/repository/pypi/simple/ --trusted-host repo.huaweicloud.com
if errorlevel 1 (
