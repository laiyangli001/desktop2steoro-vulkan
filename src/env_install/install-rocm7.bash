...
$PYTHON_EXE -m pip install python_xlib -r "$SCRIPT_DIR/requirements-pip-options.txt" --no-cache-dir --retries 5 --timeout 120
$PYTHON_EXE -m pip install -r "$SCRIPT_DIR/requirements-rocm7.txt" --no-cache-dir --retries 5 --timeout 120
