...
MESSAGE_CATALOGS = {
    ...
    "Projection RCAS tooltip": "Sets RCAS sharpening before mip generation. Recommended: 0.50.",
       ...
       "Preview":"Preview",
        ...
        "tooltip_target_fps": "Capture pacing target. Manual values stay fixed. In OpenXR Auto mode, every 60-second SBS average sets capture to SBS + 5 FPS, capped by the display refresh rate.",
    ...
    "Projection RCAS tooltip": "在生成 MIP 前设置 RCAS 锐化强度。建议值：0.50。",
        ...
        "tooltip_target_fps": "捕捉帧率节流目标。手动档位保持固定；OpenXR 自动模式每 60 秒按 SBS 平均帧率评估一次，捕获帧率设置为 SBS 平均帧率 + 5 FPS，并限制不超过显示器刷新率。",
