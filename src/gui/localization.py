...
MESSAGE_CATALOGS = {
    ...
    "Projection Min LOD tooltip": "Sets the lowest Vulkan projection mip level. Recommended: 0.00.",
    "Projection Max LOD tooltip": "Caps the highest Vulkan projection mip level. Recommended: 0.35.",
    "Projection MIP Bias tooltip": "Biases sampling toward sharper mip levels. Recommended: -0.35.",
    "Projection RCAS tooltip": "Sets RCAS sharpening before mip generation. Recommended: 0.50.",
       ...
       "Preview":"Preview",
        ...
        "tooltip_hole_fill_mode": "Occlusion fill preset: Off / No Fill disables hole filling and sets Temporal Strength to 0; Balanced / Standard keeps the realtime speed-detail balance; Content Aware / Highest Quality uses directional content-aware fill and is much slower. Defaults: Cinema = Balanced / Standard; Game = Off / No Fill; Image = Content Aware / Highest Quality.",
        ...
        "tooltip_advanced_device_options": "Show capture color controls, frame pacing, XR preview window, and image enhancement controls.",
    ...
    "Projection RCAS:": "RCAS:",
    "Projection Min LOD tooltip": "限制 Vulkan 投影可采样的最低 MIP 层级。建议值：0.00。",
    "Projection Max LOD tooltip": "限制 Vulkan 投影可采样的最高 MIP 层级。建议值：0.35。",
    "Projection MIP Bias tooltip": "使采样偏向更清晰的 MIP 层级。建议值：-0.35。",
    "Projection RCAS tooltip": "在生成 MIP 前设置 RCAS 锐化强度。建议值：0.50。",
        "Cross Eyed": "交叉眼",
        "Picture": "画面",
        "Depth": "深度",
        "Glow": "辉光",
        ...
        "tooltip_hole_fill_mode": "遮挡补洞预设：关闭 / 不补洞会禁用所有补洞算法，并将时域强度设为 0；均衡 / 标准保留实时速度和细节折中；增强 / 高质量使用方向内容感知补洞，速度会明显变慢。默认对应：电影模式 = 均衡 / 标准；游戏模式 = 关闭 / 不补洞；图片模式 = 增强 / 高质量。",
        ...
        "tooltip_advanced_device_options": "显示捕捉设备颜色调节、捕获帧率、XR画面预览窗口、本地垂直同步和画面增强选项。",
