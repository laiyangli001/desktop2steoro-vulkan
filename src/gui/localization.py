...
MESSAGE_CATALOGS = {
    ...
    "Projection RCAS tooltip": "Sets RCAS sharpening before mip generation. Recommended: 0.50.",
       ...
       "Preview":"Preview",
        ...
        "tooltip_parallel_inference": "Experimental: do not enable two-worker or three-worker inference; multi-worker inference performs worse.",
        ...
        "tooltip_target_fps": "Capture pacing target. Manual values stay fixed. In OpenXR Auto mode, the 60-second SBS average can move capture by one step between the display refresh rate, 30 FPS, and 24 FPS.",
    ...
    "Projection RCAS tooltip": "在生成 MIP 前设置 RCAS 锐化强度。建议值：0.50。",
        ...
        "tooltip_parallel_inference": "实验用：不要开启两路或三路推理，多路推理效果更差。",
        ...
        "tooltip_target_fps": "捕捉帧率节流目标。手动档位保持固定；OpenXR 自动模式每 60 秒按 SBS 平均帧率评估一次，并在显示器刷新率、30 FPS、24 FPS 之间最多调整一个档位，减少无效输入和算力浪费。",
