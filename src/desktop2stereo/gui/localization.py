...
MESSAGE_CATALOGS = {
    ...
    "Projection RCAS tooltip": "Applies RCAS after shared mip filtering and scaling. Recommended: 0.50.",
       ...
       "Preview":"Preview",
        ...
        "tooltip_window_preview": "Open an additional depth-map window that stays open when unfocused and can be captured by screenshot tools. Depth Strength 0.00 is blue, 0.25 preserves the full far-blue / mid-purple / near-red depth gradient, and 0.50 is red. Physical-display output remains active.",
    ...
    "Projection RCAS tooltip": "在统一 MIP 过滤和缩放后应用 RCAS 锐化。建议值：0.50。",
        ...
        "tooltip_window_preview": "额外打开允许截图的深度图窗口，失去焦点后不会关闭，但可以被其他窗口覆盖：深度强度 0.00 显示蓝色，0.25 保留远处蓝色—中间紫色—近处红色的完整深度渐变，0.50 显示红色；物理显示器全屏输出保持不变。",
